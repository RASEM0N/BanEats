...
- добавить тесты
- добавить сторибуки
- Добавить ленивую загрузки страниц и модулей
  - теже яндекс карты, когда они только у driver-а
- Вынести всю логику и shared в ПАКЕТы - хочется на Nuxt бахнуть потом
- Прибратся с структурой папок page - чтоб структура показывала роуты
